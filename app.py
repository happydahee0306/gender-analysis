...
try:
    ...
    with col3_2:
        ...
        # [요청 반영] 인사이트 섹션 내부에 상세 내용 배치
        with st.container():
            st.markdown("""
            **💰 성별 임금 및 소득 불평등 인식 분석** 이 조사는 0점에서 5점 사이로 응답한 결과의 평균치입니다. 점수가 높을수록 불평등이 심각하다고 느끼는 것을 의미합니다.

            **1. 경제적 불평등에 대한 전반적 인식** 남녀 모두 평균 2점 중후반대를 기록하며, 한국 사회의 임금 격차 문제를 '어느 정도 존재하며 무시할 수 없는 수준'으로 인지하고 있습니다.
            ...
            **3. 경제적 측면의 불평등 체감** 보통 성차별 조사에서는 여성의 점수가 높으나, '임금/소득' 지표에 대해서는 남성들이 이 상황을 더 심각하게 보고 있다는 점이 흥미롭습니다.
