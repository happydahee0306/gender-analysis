...
try:
   ...
   with col3_2:
        ...
        # [수정 포인트] 상세 분석 내용 (이미지처럼 리스트 형태로 표시)
        with st.expander("🔍 젠더갈등 원인 상세 분석 보기", expanded=True):
            st.markdown("""
            **💰 성별 임금 및 소득 불평등 인식 분석** 이 조사는 0점에서 5점 사이 응답 결과이며, 점수가 높을수록 불평등이 심각하다고 느끼는 것을 의미합니다.

            **1. 경제적 불평등에 대한 전반적 인식** 남녀 모두 2점 중후반대를 기록하며, 임금 격차 문제를 '무시할 수 없는 수준'으로 인지하고 있습니다.

            **2. 예상외의 결과: 남성이 더 높게 평가하는 심각도** * **남성(2.87점) > 여성(2.31점):** 주관적 '체감도' 측면에서 남성들이 기업 내 변화를 더 심각한 신호로 받아들일 수 있습니다.
